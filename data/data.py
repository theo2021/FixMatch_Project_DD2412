...
'''
weak_augmentation = torchvision.transforms.Compose([
...
class Augmented_Dataset(data.Dataset):
	def __init__(self, db, db_dict, transform=None, forget_labels=0.0)
		super().__init__()
		self.db = db
	...
	'Generates one sample of data'
		...
		#PIL loading
		im_pil = image.resize(self.db[index][0])
